...
export default function ClosedDealsScreen() {
  ...
  function renderLead({ item }: { item: Lead }) {
    return (
      <View style={styles.card}>
        ...
        <Text style={styles.meta}>
          Status: {item.lead_status || 'closed'}
        </Text>
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>✅ Closed Deals</Text>

      <Pressable style={styles.refreshButton} onPress={loadClosedDeals}>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          !loading ? (
            <View style={styles.card}>
              <Text style={styles.cardTitle}>No Closed Deals</Text>
              <Text style={styles.meta}>
